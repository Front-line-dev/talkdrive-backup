...
```csv
id,chatId,date,filename,size,contentType,downloadedAt
62177e5fa9b5ac1f0e84d5ac,96e73c34,20200611,20200611_001.jpg,21628,IMAGE,2026-02-12 15:30:00
```
...
- **다운로드 이력**: `download_history.csv`에 성공한 다운로드를 기록하여 중복 다운로드를 방지합니다. `backup.py`에서는 이미 다운로드된 파일은 다운로드를 생략하고 서버 삭제만 진행합니다.
